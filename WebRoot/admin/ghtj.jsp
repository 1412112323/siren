...
<LINK href="admin/css/admin.css" type="text/css" rel="stylesheet">
  ...
  <body>
  <form action="admin/ghtj.jsp?f=f" method="post">
	<%CommDAO dao = new CommDAO();
	 String sql = "select * from ghinfo where 1=1 and delstatus='0' ";
	 String url = "/srykzsblmis/admin/ghtj.jsp?1=1";
...
<TABLE cellSpacing=0 cellPadding=0 width="95%" align=center border=0>
  ...
  <TR height=22>
    ...
    align=middle background=admin/images/title_bg2.jpg>挂号统计</TD></TR>
...
<TABLE cellSpacing=1 cellPadding=2 width="95%" align=center border=0 bgcolor="#cccccc">
	<th bgcolor="#ffffff" colspan="9">
		...
		<a href="/srykzsblmis/studysite?ac=ghexport&key=<%=key %>&key2=<%=key2 %>&key3=<%=key3 %>">导出报表</a>
	</th>
  <TR bgcolor="#ffffff" align="center">
   ...
   DecimalFormat decimal = new DecimalFormat("#.#");
   	for(HashMap mstu:nlist){
   		String p = decimal.format(Double.valueOf(mstu.get("price").toString()));
   		tprice+=Double.valueOf(p);
	    %>
	<tr bgcolor="#ffffff" align="center">
		<td><%=mstu.get("ghno") %></td>
 ...
 <%} %>
 	<tr>
 		<td colspan="9" align="center" bgcolor="#FFFFFF">挂号收入：<%=tprice %>元</td>
 	</tr>
 	<tr>
