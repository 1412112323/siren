...
<LINK href="admin/css/admin.css" type="text/css" rel="stylesheet">
  ...
  <body>
  <form action="admin/ysf.jsp?f=f" method="post">
	<%CommDAO dao = new CommDAO();
	 String sql = "select * from zd where fkstatus='已付款'";
	 String url = "/srykzsblmis/admin/ysf.jsp?1=1";
...
<TABLE cellSpacing=0 cellPadding=0 width="95%" align=center border=0>
  ...
  <TR height=22>
    ...
    align=middle background=admin/images/title_bg2.jpg>已收费</TD></TR>
...
<TABLE cellSpacing=1 cellPadding=2 width="95%" align=center border=0 bgcolor="#cccccc">
	<th bgcolor="#ffffff" colspan="9">
		...
		收费日期：<input type="text" id="key2" name="key2" value="<%=key2 %>" readonly="readonly" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});"/>-
  ...
  <TR bgcolor="#ffffff" align="center">
   ...
   String tfghno = request.getParameter("tfghno");
   if(tfghno!=null)
   {
		dao.commOper("update zd set fkstatus='未付款' where ghno='"+tfghno+"'");
   }
   ...
   ArrayList<HashMap> nlist=(ArrayList)bean.getCollection();
	...
	<tr bgcolor="#ffffff" align="center">
		...
		<td>
		<%if(mstu.get("qystatus").equals("未取药")&&mstu.get("fkstatus").equals("已付款")){ %>
		<a href="admin/ysf.jsp?tfghno=<%=mstu.get("ghno") %>">退费</a>
		<%} %>
		</td>
	</tr>
 <%} %>
