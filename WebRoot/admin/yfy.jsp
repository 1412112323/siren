...
<LINK href="admin/css/admin.css" type="text/css" rel="stylesheet">
  ...
  <body>
  <form action="admin/yfy.jsp?f=f" method="post">
	<%CommDAO dao = new CommDAO();
	 String sql = "select * from zd where fkstatus='已付款' and qystatus='已取药' ";
	 String url = "/srykzsblmis/admin/yfy.jsp?1=1";
...
<TABLE cellSpacing=0 cellPadding=0 width="95%" align=center border=0>
  ...
  <TR height=22>
    ...
    align=middle background=admin/images/title_bg2.jpg>发药记录</TD></TR>
