...
<LINK href="admin/css/admin.css" type="text/css" rel="stylesheet">
  ...
  <body>
  <form action="admin/jzghlist.jsp?f=f" method="post">
	<%CommDAO dao = new CommDAO();
	 String sql = "select * from ghinfo where 1=1 and delstatus='0' and ghdept='"+admin.get("dept")+"' and status='待问诊' ";
	 String url = "/srykzsblmis/admin/jzghlist.jsp?1=1";
...
<TABLE cellSpacing=0 cellPadding=0 width="95%" align=center border=0>
  ...
  <TR height=22>
    ...
    align=middle background=admin/images/title_bg2.jpg>挂号信息</TD></TR>
  ...
  <TR bgcolor="#ffffff" align="center">
   ...
   ArrayList<HashMap> nlist=(ArrayList)bean.getCollection();
	...
	<tr bgcolor="#ffffff" align="center">
		...
		<td>
		<a href="admin/brwz.jsp?ghno=<%=mstu.get("ghno") %>">问诊</a>
		</td>
	</tr>
 <%} %>
 	<tr>
