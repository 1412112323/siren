...
<LINK href="admin/css/admin.css" type="text/css" rel="stylesheet">
  ...
  <body>
  <form action="admin/dfy.jsp?f=f" method="post">
	<%CommDAO dao = new CommDAO();
	 String sql = "select * from zd where fkstatus='已付款' and qystatus='未取药' ";
	 String url = "/srykzsblmis/admin/dfy.jsp?1=1";
...
<TABLE cellSpacing=0 cellPadding=0 width="95%" align=center border=0>
  ...
  <TR height=22>
    ...
    align=middle background=admin/images/title_bg2.jpg>待取药</TD></TR>
  ...
  <TR bgcolor="#ffffff" align="center">
   ...
   ArrayList<HashMap> nlist=(ArrayList)bean.getCollection();
	...
	<tr bgcolor="#ffffff" align="center">
		...
		<td><a href="/srykzsblmis/studysite?ac=qy&ghno=<%=mstu.get("ghno") %>">确认取药</a></td>
	</tr>
 <%} %>
 	<tr>
...
{
 %>
 alert("有药品库存不足，请补仓后再操作");
 <%}
if(suc!=null)
{
 %>
 alert("操作成功");
location.replace("/srykzsblmis/admin/dfy.jsp");
 <%}%>
</script>
