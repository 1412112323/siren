...
<LINK href="admin/css/admin.css" type="text/css" rel="stylesheet">
  ...
  <body>
  <form action="/srykzsblmis/studysite?ac=ypcfadd" name="f1" method="post" onsubmit="return ck()">
   <TABLE cellSpacing=0 cellPadding=0 width="95%" align=center border=0>
  <TR height=20>
    <TD></TD></TR>
  <TR height=22>
    <TD style="PADDING-LEFT: 20px; FONT-WEIGHT: bold; COLOR: #ffffff" 
    align=middle background=admin/images/title_bg2.jpg>新增药品、处置</TD></TR>
  ...
  <TR height=20>
    ...
    <TABLE cellSpacing=1 cellPadding=2 width="95%" align=center border=0 bgcolor="#cccccc">
    	<tr bgcolor="#ffffff">
    		<td>编号</td>
    		<td><input type="text"  id="yno" name="yno"/>*</td>
    	</tr>
    	<tr bgcolor="#ffffff">
    		<td>名称</td>
